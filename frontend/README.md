...
You will probably want to set up a reverse proxy, TLS, etc. There are sample Caddy and nginx configuration files in the top level of the repository for reference, but note that support for such tasks is outside the scope of this project.
